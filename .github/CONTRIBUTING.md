...
We accept bug reports via issues created on [Github](https://github.com/thephpleague/uri-hostname-parser/issues).
...
We accept contributions via Pull Requests on [Github](https://github.com/thephpleague/uri-hostname-parser/pull).
